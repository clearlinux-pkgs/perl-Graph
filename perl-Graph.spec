...
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETJ/Graph-0.9720.tar.gz
...
%prep
%setup -q -n Graph-0.9720
cd %{_builddir}
tar xf %{_sourcedir}/libgraph-perl_0.96-2.debian.tar.xz
cd %{_builddir}/Graph-0.9720
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Graph-0.9720/deblicense/
